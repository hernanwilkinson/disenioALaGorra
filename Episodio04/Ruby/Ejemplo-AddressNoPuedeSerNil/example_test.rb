...
class ExampleTest < MiniTest::Unit::TestCase
  ...
  def test_can_look_for_customers_in_a_city
    ...
    customer_at_belgrano = Customer.named 'Juan Perez', address_at_belgrano

    agenda.add customer_at_olivos
    agenda.add customer_at_belgrano
  ...
  def belgrano_zip_code
    '1010'
  end

  def address_at_belgrano
    Address.at'Cabildo 111', belgrano, belgrano_zip_code
  end
end
